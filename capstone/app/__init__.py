...
def create_app(test_config=None):
    ...
    ############################### POST movies and actor end point #############################
    ...
    def update_movie(payload, movie_id):
        ...
        return jsonify({"success": True, "updated": updated_movie.format()})
    ...
    def update_actor(payload, actor_id):
        ...
        try:
            ...
            abort(
                400, "Bad formatted request due to nonexistent movie id" + str(movie_id)
            )

        return jsonify({"success": True, "updated": updated_actor.format()})
